...
class Create_organization_service extends MY_Controller
{
    ...
    {
        parent::__construct();
        $this->load->model('create_organization/services/Create_organization_model');
        $this->load->database();
    }
    ...
    public function save()
    {
        ...
        $this->Create_organization_model->OrgName = $this->input->post('organization_name');
        $this->Create_organization_model->EmailAddress = $this->input->post('email');
        $this->Create_organization_model->ContactPerson = $this->input->post('contact_person');
        $this->Create_organization_model->ContactNumber = $this->input->post('contact_number');
        $this->Create_organization_model->Address = $this->input->post('address');
        $this->Create_organization_model->image = $_FILES['image'];
