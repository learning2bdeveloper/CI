...
class Create_organization_service extends MY_Controller
{
    ...
    public function delete()
    {
        ...
        $response = $this->create_organization_model->delete_method_from_model($this->input->post('id'));
        echo json_encode($response);
    }
    ...
    public function edit()
    {
        ...
        $response = $this->create_organization_model->edit_method_from_model($data);
        echo json_encode($response);
    }
}
