...
<body>
    ...
    <div class="container" style="max-width: 45vw;">
        <div class="text-center mb-4" style="background-color: black; color: white; padding: 3px;">
            <h3>Add New Client Profile</h3>
            <p class>Complete the Form Below to Add New Client Profile</p>
        </div>
        ...
        <div class="container d-flex justify-content-center">
            ...
            <div class="row">
                ...
                <input type="text" class="form-control" name="middle_name" id="middle_name"> <br>
                ...
                <button class="btn btn-success" data-bs-toggle="modal" data-bs-target="#saveModal" type="button" id="saveinfo">Save</button>
                <button class="btn btn-danger" type="button" id="cancelform">Cancel</button>
                </div>
            </div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button  id="clientSave" type="button" class="btn btn-primary">Yes</button>
      </div>
    </div>
  </div>
</div>
