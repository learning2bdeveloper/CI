...
class Organization_service_controller extends MY_Controller
{
    ...
    public function login()
    {
        ...
        $this->Organization_model_services->username = $this->input->post('login_username');
        $this->Organization_model_services->pwd = $this->input->post('login_pwd');

        $response = $this->Organization_model_services->login_method_from_model();
