            ...
            <div class="text-center">
                <div class="row align-items-center">
                    <div class="col-sm-6 d-flex align-items-center">
                        <div class="dropdown">
                            <button id="dropbtn" class="btn btn-dark me-2">&#9660;</button>
                            <div class="dropdown-content">
                            </div>
                        </div>
                        <button id="btn_add_new" class="btn btn-success me-2">Add Organization</button>
                ...
                <div style="max-height: 560px; overflow-y: auto;">
                    <table id="example" class="table table-borderless table-hover" style="width:98%">
                        ...
                        <tbody id="table">
                            <!-- Data will be loaded here via Load_organization.php -->
                        </tbody>
                    </table>
                </div>
